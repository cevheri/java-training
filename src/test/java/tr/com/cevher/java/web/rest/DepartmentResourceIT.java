...
import tr.com.cevher.java.service.mapper.DepartmentMapper;
...
class DepartmentResourceIT {
    ...
    private static final DepartmentType DEFAULT_TYPE = DepartmentType.SERVICE;
    private static final DepartmentType UPDATED_TYPE = DepartmentType.POLYCLINIC;
    ...
    void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getActive()).isEqualTo(DEFAULT_ACTIVE);
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).type(UPDATED_TYPE).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
        ...
        assertThat(testDepartment.getActive()).isEqualTo(UPDATED_ACTIVE);
    }
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.type(UPDATED_TYPE).active(UPDATED_ACTIVE);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).type(UPDATED_TYPE).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
