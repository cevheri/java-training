...
export const ProductsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="javaTrainingApp.products.delete.question">
        <Translate contentKey="javaTrainingApp.products.delete.question" interpolate={{ id: productsEntity.id }}>
