...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSTEMSETUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_SYSTEMSETUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SYSTEMSETUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SYSTEMSETUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SYSTEMSETUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SYSTEMSETUP actions', async () => {
      const expectedActions = [
        {
