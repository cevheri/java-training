...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './doctor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCTOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCTOR actions', async () => {
      const expectedActions = [
        {
