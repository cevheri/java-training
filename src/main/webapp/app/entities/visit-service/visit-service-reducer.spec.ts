...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VISITSERVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VISITSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VISITSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VISITSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VISITSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VISITSERVICE actions', async () => {
      const expectedActions = [
        {
